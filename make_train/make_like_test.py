...
source_file_path = offline_test_file_path
...
with codecs.open('../train_data/like_test_data.csv','w','utf-8') as save_file:
    save_file.write('uid,mid,cid,discount,top_discount,distance,date_received\n')
