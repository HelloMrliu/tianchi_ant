...
like_train_file_path = '../train_data/like_test_data.csv'
save_file_path = '../train_data/test_data.csv'
...
date_received_list = like_train_data['date_received']
...
for index in range(len(cid_list)):
    ...
    temp_list.append(str(date_received))
...
with codecs.open(save_file_path, 'w', 'utf-8') as save_file:
    save_file.write('uid,mid,cid,discount,top_discount,distance,date_received,' + ','.join(title_list) + '\n')
